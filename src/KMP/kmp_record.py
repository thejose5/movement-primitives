...
LINE_COLOR = BLACK
REC_TRAJECTORY = []
SAVE_LOCATION = '/home/thejus/catkin_ws/src/movement_primitives/training_data/KMP_static_0.01/'
...
def startRecording(refresh_button, stop_button, game_display):
    ...
    while True:
        ...
        if i%SAVE_FREQ == 1:
            REC_TRAJECTORY.append((time_ind*DEMO_dT,) + pygame.mouse.get_pos() + tuple([x/DEMO_dT for x in pygame.mouse.get_rel()]))
            time_ind += 1
        i+=1
        pygame.display.update()
